    ...
    <div class="details-container">
        ...
        <div class="stats-overview">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">{{ \Carbon\Carbon::createFromFormat('Y-m', "$year-$month")->format('d') }}</div>
                <div class="stat-label">Hari dalam Bulan</div>
            </div>
            <div class="stat-card">
                <div class="stat-icon">
                    <i class="fas fa-chart-line"></i>
                </div>
                <div class="stat-value">{{ $articles->total() > 0 ? number_format($articles->total() / \Carbon\Carbon::createFromFormat('Y-m', "$year-$month")->daysInMonth, 1) : '0' }}</div>
